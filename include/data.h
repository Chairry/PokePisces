...
#define TRAINER_PARTY_IVS_OLD(hp, atk, def, speed, spatk, spdef) (hp | (atk << 5) | (def << 10) | (speed << 15) | (spatk << 20) | (spdef << 25))
#define TRAINER_PARTY_IVS(hp, atk, def, speed, spatk, spdef) (31)

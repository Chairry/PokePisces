...
#define B_PRANKSTER_DARK_TYPES      GEN_LATEST // In Gen7+, Prankster-elevated status moves do not affect Dark type Pok?mon.
...
// Other settings
#define B_DOUBLE_WILD_CHANCE            100         // % chance of encountering two Pok?mon in a Wild Encounter.
...
#define B_OVERWORLD_SNOW                GEN_9 // In Gen9+, overworld Snow will summon snow instead of hail.

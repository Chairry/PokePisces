...
#define MOVE_EFFECT_METEOR_MASH (PRIMARY_STATUS_MOVE_EFFECT + 77)
#define MOVE_EFFECT_DEF_SPDEF_UP (PRIMARY_STATUS_MOVE_EFFECT + 78)
#define MOVE_EFFECT_CINDER_TWIRL (PRIMARY_STATUS_MOVE_EFFECT + 79)
#define MOVE_EFFECT_CINDER_DRILL (PRIMARY_STATUS_MOVE_EFFECT + 80)
#define MOVE_EFFECT_RADIOACID (PRIMARY_STATUS_MOVE_EFFECT + 81)
#define MOVE_EFFECT_HEART_CARVE (PRIMARY_STATUS_MOVE_EFFECT + 82)
#define MOVE_EFFECT_DEF_ACC_DOWN (PRIMARY_STATUS_MOVE_EFFECT + 83)
#define MOVE_EFFECT_ALL_STATS_DOWN (PRIMARY_STATUS_MOVE_EFFECT + 84)
#define MOVE_EFFECT_TOXIC_SPIKES (PRIMARY_STATUS_MOVE_EFFECT + 85)
#define NUM_MOVE_EFFECTS (PRIMARY_STATUS_MOVE_EFFECT + 86)

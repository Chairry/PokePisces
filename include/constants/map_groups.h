...
#define MAP_EVER_GRANDE_ROAD            (100 | (0 << 8))
#define MAP_EVER_GRANDE_PEAK            (101 | (0 << 8))
#define MAP_CAVE_OF_ORIGIN              (102 | (0 << 8))
#define MAP_UNDURA_TUNNELS              (103 | (0 << 8))
#define MAP_UNDURA_TUNNELS_DEEP         (104 | (0 << 8))
#define MAP_MIDNEOR_FALLS_CAVE          (105 | (0 << 8))
#define MAP_METEOR_NADIR                (106 | (0 << 8))
#define MAP_EVER_GRANDE_TRANSITION_CAVE (107 | (0 << 8))

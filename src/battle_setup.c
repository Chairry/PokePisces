...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    //[REMATCH_WALTER] = REMATCH(TRAINER_P_AUDREY_II, TRAINER_P_LIBRA, TRAINER_P_BATES, TRAINER_P_CHINZAO, TRAINER_P_MARIMAR, ROUTE121),
    ...
    //[REMATCH_ANNA_AND_MEG] = REMATCH(TRAINER_P_DIMITRI, TRAINER_P_CLIFF_AND_ISSA, TRAINER_P_RODAN, TRAINER_P_MOTHRA, TRAINER_P_LANE, ROUTE117),
    //[REMATCH_ISABEL] = REMATCH(TRAINER_P_THAD, TRAINER_P_LEELA, TRAINER_P_ICKLE, TRAINER_P_STAPH, TRAINER_P_HWARANG, ROUTE110),
    //[REMATCH_MIGUEL] = REMATCH(TRAINER_P_HEDORAH, TRAINER_P_GHIDORAH, TRAINER_P_GOJIRA, TRAINER_P_GAMERA, TRAINER_P_SANTO, ROUTE103),
    ...
    //[REMATCH_TRENT] = REMATCH(TRAINER_P_GONZEROS, TRAINER_P_TOPAZ_3, TRAINER_P_FINAL_MONK, TRAINER_P_GARENA, TRAINER_P_GORO, ROUTE112),
    //[REMATCH_SAWYER] = REMATCH(TRAINER_SAWYER_1, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MT_CHIMNEY),
    //[REMATCH_KIRA_AND_DAN] = REMATCH(TRAINER_P_TOPAZ_4, TRAINER_P_TOPAZ_5, TRAINER_P_TOPAZ_6, TRAINER_P_TOPAZ_7, TRAINER_P_TOPAZ_8, ABANDONED_SHIP_ROOMS2_1F),

...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_BASALIN_COAST] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MANGROTTO_TUNNEL] = MAPPOPUP_THEME_STONE,
    [MAPSEC_COSMOSS_BRIDGE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_PRECIPIKE_BLUFF] = MAPPOPUP_THEME_STONE,
    [MAPSEC_SUNBEACH_STRAIT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ARCTAIGA_ROAD] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_BRUMIST_CLIFFS] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ZOTPYRE_SHRINE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ZOTPYRE_VILLAGE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SCUTTILL_WAY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SCUTTILL_HUTS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CANOPOUR_WILDS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PERPLUME_MAZE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_OZONE_INSTITUTE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MASONRIED_HIKE] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_THE_ASHLANDS] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_CRIMNEY_CLIMB] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_JAGGRO_PASS] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_CRIMNEY_CATACOMBS] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_SWELTORN_DESERT] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_SWELTORN_PALACE] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_HATCHLOAM_FIELD] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TRICK_HOUSE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_CYCLING_ROAD] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SEA_MAUVILLE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MAINTENANCE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_SLATEPORT_CHORE] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_NAVIGULF_WAVES] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_STRAE_SEAPATH] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_SAILORS_PAUSE] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_ICIPIKE_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_DETERMANITE_BEACH] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_DETERMANITE_QUARRY] = MAPPOPUP_THEME_STONE,
    [MAPSEC_UNDERWATER_UNDURA] = MAPPOPUP_THEME_STONE2,
    ...
    [MAPSEC_WISHWELL_OCEAN] = MAPPOPUP_THEME_UNDERWATER,
    ...
    [MAPSEC_RUSTBURG_WHARF] = MAPPOPUP_THEME_STONE,
    [MAPSEC_UNDURA_TUNNELS] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_NEW_MAUVILLE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MIDNEOR_FALLS] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_METEOR_FALLS2] = MAPPOPUP_THEME_STONE,
    [MAPSEC_WHISPER_CLIFFS] = MAPPOPUP_THEME_STONE,
    [MAPSEC_AQUA_HIDEOUT_OLD] = MAPPOPUP_THEME_STONE,
    [MAPSEC_NOVICES_WALK] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PENDING_DEV] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MIDNEOR_NADIR] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_EVER_GRANDE_ROAD] = MAPPOPUP_THEME_MARBLE,
    ...
    [MAPSEC_CRIMNEY_CALDERA] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_FIERY_PATH2] = MAPPOPUP_THEME_STONE,
    [MAPSEC_GOLDEN_PLAINS] = MAPPOPUP_THEME_MARBLE,

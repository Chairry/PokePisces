...
const u32 gMonFrontPic_Clawlistic[] = INCBIN_U32("graphics/pokemon/clawlistic/front.4bpp.lz");
const u32 gMonPalette_Clawlistic[] = INCBIN_U32("graphics/pokemon/clawlistic/normal.gbapal.lz");
const u32 gMonBackPic_Clawlistic[] = INCBIN_U32("graphics/pokemon/clawlistic/back.4bpp.lz");
const u32 gMonShinyPalette_Clawlistic[] = INCBIN_U32("graphics/pokemon/clawlistic/shiny.gbapal.lz");
const u8 gMonIcon_Clawlistic[] = INCBIN_U8("graphics/pokemon/clawlistic/icon.4bpp");
const u8 gMonFootprint_Clawlistic[] = INCBIN_U8("graphics/pokemon/clawlistic/footprint.1bpp");

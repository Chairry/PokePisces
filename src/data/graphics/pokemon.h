...
const u32 gMonFrontPic_Happea[] = INCBIN_U32("graphics/pokemon/63happea/front.4bpp.lz");
const u32 gMonPalette_Happea[] = INCBIN_U32("graphics/pokemon/63happea/normal.gbapal.lz");
const u32 gMonBackPic_Happea[] = INCBIN_U32("graphics/pokemon/63happea/back.4bpp.lz");
const u32 gMonShinyPalette_Happea[] = INCBIN_U32("graphics/pokemon/63happea/shiny.gbapal.lz");
const u8 gMonIcon_Happea[] = INCBIN_U8("graphics/pokemon/63happea/icon.4bpp");
const u8 gMonFootprint_Happea[] = INCBIN_U8("graphics/pokemon/63happea/footprint.1bpp");
#endif

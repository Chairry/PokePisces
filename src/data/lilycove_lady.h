...
static const u16 sContestLadyMonGfxId[] =
{
    ...
    [CONTEST_CATEGORY_BEAUTY] = OBJ_EVENT_GFX_MARINAROC,
    [CONTEST_CATEGORY_CUTE]   = OBJ_EVENT_GFX_SNELFREND,
    [CONTEST_CATEGORY_SMART]  = OBJ_EVENT_GFX_SHELLYLOUH,
    [CONTEST_CATEGORY_TOUGH]  = OBJ_EVENT_GFX_HEMOKO
};

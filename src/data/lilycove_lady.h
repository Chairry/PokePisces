...
{
    [CONTEST_CATEGORY_COOL]   = SPECIES_ARCEUS,
    [CONTEST_CATEGORY_BEAUTY] = SPECIES_ARCEUS,
    [CONTEST_CATEGORY_CUTE]   = SPECIES_ARCEUS,
    [CONTEST_CATEGORY_SMART]  = SPECIES_ARCEUS,
    [CONTEST_CATEGORY_TOUGH]  = SPECIES_ARCEUS
};

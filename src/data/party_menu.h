...
{
    [FIELD_MOVE_CUT]          = MOVE_BREAKNECK_BLITZ,
    [FIELD_MOVE_FLASH]        = MOVE_BREAKNECK_BLITZ,
    [FIELD_MOVE_ROCK_SMASH]   = MOVE_BREAKNECK_BLITZ,
    [FIELD_MOVE_STRENGTH]     = MOVE_BREAKNECK_BLITZ,
    [FIELD_MOVE_SURF]         = MOVE_BREAKNECK_BLITZ,
    [FIELD_MOVE_FLY]          = MOVE_BREAKNECK_BLITZ,
    [FIELD_MOVE_DIVE]         = MOVE_BREAKNECK_BLITZ,
    [FIELD_MOVE_WATERFALL]    = MOVE_BREAKNECK_BLITZ,

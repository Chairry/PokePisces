static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SKY_PILLAR_NEW - 1] = {MAP_GROUP(SKY_PILLAR_NEW), MAP_NUM(SKY_PILLAR_NEW), 20, 20},
    ...
    [HEAL_LOCATION_FLOTSHORE_TEST - 1] = {MAP_GROUP(FLOTSHORE_TEST), MAP_NUM(FLOTSHORE_TEST), 10, 10},
};

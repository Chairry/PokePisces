...
static const u8 sChlorophyllDescription[] = _("Boosts Spd and Grass-type\nmoves in harsh sunlight.");
...
static const u8 sBrandClawsDescription[] = _("Crits against burned foes.\nContact moves may burn.");

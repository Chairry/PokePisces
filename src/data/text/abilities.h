...
static const u8 sStaminaDescription[] = _("Boosts the Defense stat when\nthe user is hit by a move.");
...
static const u8 sQueenlyMajestyDescription[] = _("The opposing Pokémon, cannot\nattack using priority moves.");
...
static const u8 sNeutralizingGasDescription[] = _("Negates abilities until the\nfoe switches.");
...
static const u8 sTransistorDescription[] = _("Powers up Electric-type\nmoves.");
...
static const u8 sAmbusherDescription[] = _("Crits 1st on the first turn\nor when using a 2-turn move.");
static const u8 sCacophonyDescription[] = _("Makes the user and allies\nresist sound-based moves.");
static const u8 sCrueltyDescription[] = _("Powers up Dark-type moves.");
static const u8 sFriendlyAuraDescription[] = _("Raises speed of allies.");
...
static const u8 sBrandClawsDescription[] = _("Critical-hits against burned\nfoes. Contact moves may burn.");
...
static const u8 sDrainageDescription[] = _("Boosts the power of draining\nmoves when at half HP.");
...
static const u8 sEvilEyeDescription[] = _("Lowers the foe's Speed stat.\nEncounter rate decreases.");

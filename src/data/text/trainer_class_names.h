const u8 gTrainerClassNames[][18] = {
    ...
    [TRAINER_CLASS_STROLLER] = _("Stroller Tia &"),
    ...
    [TRAINER_CLASS_GILDED_MONK] = _("Topaz Monk"),
    [TRAINER_CLASS_CHEERLEADERS] = _("Cheerleader"),
    [TRAINER_CLASS_HUNTER] = _("Hunter"),
    [TRAINER_CLASS_BREADWINNER] = _("Breadwinner"),
    [TRAINER_CLASS_TOPAZ_ACOLYTE] = _("Topaz Acolyte"),
    [TRAINER_CLASS_MARCHONESS] = _("Marchoness"),
};

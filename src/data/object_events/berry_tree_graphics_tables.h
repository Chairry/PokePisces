...
const struct SpriteFrameImage *const gBerryTreePicTablePointers[] = {
    ...
    [ITEM_YELLOW_SODA - FIRST_BERRY_INDEX]             = sPicTable_RazzBerryTree,
...
const u8 *const gBerryTreePaletteSlotTablePointers[] = {
    ...
    [ITEM_YELLOW_SODA - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Razz,
...
const u8 *const gBerryTreeObjectEventGraphicsIdTablePointers[] = {
    ...
    [ITEM_YELLOW_SODA - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,

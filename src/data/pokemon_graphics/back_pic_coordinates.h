...
const struct MonCoords gMonBackPicCoords[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_LEDYBA]                       = { .size = MON_COORDS_SIZE(57, 20), .y_offset = 14 },
    [SPECIES_LEDIAN]                       = { .size = MON_COORDS_SIZE(59, 47), .y_offset =  7 },
    ...
    [SPECIES_ZIGZAGOON]                    = { .size = MON_COORDS_SIZE(64, 37), .y_offset = 13 },
    [SPECIES_LINOONE]                      = { .size = MON_COORDS_SIZE(47, 41), .y_offset =  9 },
    ...
    [SPECIES_SPOINK]                       = { .size = MON_COORDS_SIZE(40, 49), .y_offset =  5 },
    [SPECIES_GRUMPIG]                      = { .size = MON_COORDS_SIZE(54, 53), .y_offset =  6 },
    ...
    [SPECIES_QUILWARD]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_BONFEU]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_INFRAREC]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_BERM]                         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_MOODA]                        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_BERMUDON]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    ...
    [SPECIES_EBIBI]                        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_MAKIBI]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_EBIROSASHI]                   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_KITIKITI]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_MOSKOPO]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    ...
    [SPECIES_COFFIDDLE]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
#endif

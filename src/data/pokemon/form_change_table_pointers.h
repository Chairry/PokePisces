const struct FormChange *const gFormChangeTablePointers[NUM_SPECIES] =
{
    ...
    [SPECIES_ZYGARDE_10_DORMANT] = sZygardeDormantFormChangeTable,
    [SPECIES_ZYGARDE_50_DORMANT] = sZygardeDormantFormChangeTable,
    [SPECIES_ZYGARDE_COMPLETE] = sZygardeDormantFormChangeTable,
    ...
    [SPECIES_CINDRILLON_PIRROUETTE] = sCindrillonFormChangeTable,

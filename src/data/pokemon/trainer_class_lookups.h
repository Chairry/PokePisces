const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_RED] = TRAINER_PIC_PRESENTER,
    ...
    [FACILITY_CLASS_BIRD_WATCHER] = TRAINER_PIC_BIRD_WATCHER,
    [FACILITY_CLASS_DRAGON_RIDER] = TRAINER_PIC_DRAGON_RIDER,
    [FACILITY_CLASS_PAPER_BOY] = TRAINER_PIC_PAPER_BOY,
    [FACILITY_CLASS_PICKNICKER] = TRAINER_PIC_PICNICKER,
    [FACILITY_CLASS_SEA_SHELLER] = TRAINER_PIC_SEA_SHELLER,
    [FACILITY_CLASS_FAIRYTALE_GIRL] = TRAINER_PIC_FAIRYTALE_GIRL,
    [FACILITY_CLASS_SNOW_KID] = TRAINER_PIC_SNOW_KID,
    [FACILITY_CLASS_SNOW_CHILD] = TRAINER_PIC_SNOW_CHILD,
    [FACILITY_CLASS_ANGLER] = TRAINER_PIC_ANGLER,
    [FACILITY_CLASS_VANDAL] = TRAINER_PIC_VANDAL,
    [FACILITY_CLASS_KLUTZ] = TRAINER_PIC_KLUTZ,
    [FACILITY_CLASS_STREET_THUG] = TRAINER_PIC_STREET_THUG,
    [FACILITY_CLASS_DELINQUENT] = TRAINER_PIC_DELINQUENT,
    [FACILITY_CLASS_CLIMBER] = TRAINER_PIC_CLIMBER,
};
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_BIRD_WATCHER] = TRAINER_CLASS_BIRD_WATCHER,
    [FACILITY_CLASS_DRAGON_RIDER] = TRAINER_CLASS_DRAGON_RIDER,
    [FACILITY_CLASS_PAPER_BOY] = TRAINER_CLASS_PAPER_BOY,
    [FACILITY_CLASS_PICKNICKER] = TRAINER_CLASS_PICNICKER,
    [FACILITY_CLASS_SEA_SHELLER] = TRAINER_CLASS_SEA_SHELLER,
    [FACILITY_CLASS_FAIRYTALE_GIRL] = TRAINER_CLASS_FAIRYTALE_GIRL,
    [FACILITY_CLASS_SNOW_KID] = TRAINER_CLASS_SNOW_KID,
    [FACILITY_CLASS_SNOW_CHILD] = TRAINER_CLASS_SNOW_CHILD,
    [FACILITY_CLASS_ANGLER] = TRAINER_CLASS_ANGLER,
    [FACILITY_CLASS_VANDAL] = TRAINER_CLASS_VANDAL,
    [FACILITY_CLASS_KLUTZ] = TRAINER_CLASS_KLUTZ,
    [FACILITY_CLASS_STREET_THUG] = TRAINER_CLASS_STREET_THUG,
    [FACILITY_CLASS_DELINQUENT] = TRAINER_CLASS_DELINQUENT,
    [FACILITY_CLASS_CLIMBER] = TRAINER_CLASS_CLIMBER,
};
